...
def train_lexical(train_csv_path="data/splits/train.csv", model_dir="models"):
    print("=" * 60)
    ...
    # Note: We fit the vectorizer on the whole training set
    ...
    # 5. Internal Cross-Validation (Optional, for monitoring)
    # This evaluates how well the model performs within the training set
    ...
    model_path = os.path.join(model_dir, "svm_lexical.joblib")
    vect_path = os.path.join(model_dir, "vectorizer_lexical.joblib")
